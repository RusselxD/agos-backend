...
from app.schemas import SensorReadingPaginatedResponse, SensorReadingCreate, SensorDataRecordedResponse
...
async def get_sensor_readings_paginated(page: int = 1, 
    ...
    return await sensor_reading_service.get_items_paginated(db=db, page=page, page_size=page_size)
