...
class CRUDNotificationTemplate(CRUDBase):
    ...
    async def create(
        self, 
        db: AsyncSession, 
        obj_in: CreateNotificationTemplateRequest, 
        created_by_id: UUID) -> NotificationTemplate:
    ...
    async def get_by_type(
            self, 
            db: AsyncSession, 
            notification_type: NotificationType) -> NotificationTemplate | None:
    ...
    async def demote_to_announcement(self, db: AsyncSession, template: NotificationTemplate) -> None:
