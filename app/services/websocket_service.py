...
from app.schemas.sensor_reading import SensorReadingSummaryResponse
...
class WebSocketService:
    ...
    async def _get_initial_sensor_reading_data(self, db: AsyncSession) -> SensorReadingSummaryResponse:
        ...
        # Check if the latest reading is older than 4 minutes (stale or beyond the grace period but within warning period)
